...
if __name__ == '__main__':
    ...
    # Archivos de salida:
    if Coef==0.:
        fout_evolucion = 'DD_evolucion_Source_a%4.2f_t%4.2fx%i.%i.sin.nc' % (alpha, tau, points, rank)
        fout_series    = 'DD_series_Source_a%4.2f_t%4.2fx%i.%i.sin.nc' % (alpha, tau, points, rank)
    else:
        fout_evolucion = 'DD_evolucion_Source_a%4.2f_t%4.2fx%i.%i.nc' % (alpha, tau, points, rank)
        fout_series    = 'DD_series_Source_a%4.2f_t%4.2fx%i.%i.nc' % (alpha, tau, points, rank)
